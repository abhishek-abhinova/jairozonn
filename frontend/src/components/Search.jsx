...
<div key={category.id} tabIndex={category.id} className="w-[116px] mx-auto flex items-center justify-center bg-gray-300 border border-gray-300 rounded-md cursor-pointer"> 
